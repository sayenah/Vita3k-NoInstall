...
"""
    ...
    # Joined here rather than inline in the f-string below: an expression part cannot contain a
    # backslash before Python 3.12 (PEP 701), and the Android build may pick an older interpreter.
    locale_table = ",\n".join(locale_blocks)
